  ...
  zh: {
    ...
    privacy: {
      ...
      panels: [
        ...
        [
          "作业和学习结果",
          "教师或家长登录后发布作业或保存自定义词表时，标题、单词、设置和截止时间会保存到 Cloudflare D1。学生昵称和档案，以及档案与不同作业完成结果之间的关联，用于展示跨作业掌握度并生成智能复习。已完成结果及其历史在免费套餐保存 14 天，在家长套餐和教师套餐保存 365 天，之后过期。已保存词表会保留到用户主动删除。学生档案可归档和恢复；归档不会删除档案或关联结果。删除作业时，其结果也会一并删除。我们不采集学生邮箱、IP 地址或 User-Agent。",
        ],
        [
          "访问分析",

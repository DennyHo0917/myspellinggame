...
function render(locale) {
  ...
  const links = [
    ...
    `<a href="${prefix}/spelling-practice-for-parents">${footerLinks[locale.code][1]}</a>`,
    `<a href="${prefix}/custom-spelling-words-game">${footerLinks[locale.code][2]}</a>`,
    `<a href="${prefix}/spelling-assignments-for-teachers">${footerLinks[locale.code][3]}</a>`,
    `<a href="${prefix}/weekly-spelling-practice">${footerLinks[locale.code][4]}</a>`,
    `<a href="${prefix}/faq">${footerLinks[locale.code][5]}</a>`,
    `<a href="${prefix}/privacy">${footerLinks[locale.code][6]}</a>`,
    `<a href="${prefix}/about">${footerLinks[locale.code][7]}</a>`,
    `<a href="${prefix}/contact">${footerLinks[locale.code][8]}</a>`,
  ].join(" &middot; ");

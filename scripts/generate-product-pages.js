...
const copy = {
  en: {
    ...
    proItems: [
      ...
      "Up to 150 learner profiles with no per-student fees",
  ...
  es: {
    ...
    proItems: [
      ...
      "Hasta 150 perfiles de aprendiz, sin cargos por estudiante",
    ...
    language: "Idioma",
    note: "Los docentes inician sesión. Los aprendices entran mediante un enlace, sin cuentas ni contraseñas.",
  },
  "pt-BR": {
    ...
    proItems: [
      ...
      "Até 150 perfis de aprendiz, sem cobrança por estudante",
    ...
    language: "Idioma",
    note: "Professores entram com sua conta. Aprendizes participam por link, sem conta ou senha.",
  },
  fr: {
    ...
    proItems: [
      ...
      "Jusqu’à 150 profils d’apprenant, sans frais par apprenant",
    ...
    language: "Langue",
    note: "Les enseignants se connectent. Les apprenants rejoignent l’activité par lien, sans compte ni mot de passe.",
  },
  id: {
    ...
    proItems: [
      ...
      "Hingga 150 profil pelajar tanpa biaya per pelajar",
    ...
    language: "Bahasa",
    note: "Guru cukup masuk. Pelajar bergabung lewat tautan, tanpa akun atau kata sandi.",
  },
  zh: {

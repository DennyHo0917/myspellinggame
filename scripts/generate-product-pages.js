...
function render(locale) {
  ...
  const links = [
    ...
    `<a href="${prefix}/faq">${footerLinks[locale.code][4]}</a>`,
    `<a href="${prefix}/privacy">${footerLinks[locale.code][5]}</a>`,
    `<a href="${prefix}/about">${footerLinks[locale.code][6]}</a>`,
    `<a href="${prefix}/contact">${footerLinks[locale.code][7]}</a>`,
  ].join(" &middot; ");

...
const MESSAGES = {
  en: {
    ...
    workspaceCtaFootnote: "Free account · Google sign-in",
  ...
  es: {
    ...
    workspaceCtaFootnote: "Cuenta gratis · Acceso con Google",
  ...
  "pt-BR": {
    ...
    workspaceCtaFootnote: "Conta grátis · Login com Google",
  ...
  fr: {
    ...
    workspaceCtaFootnote: "Compte gratuit · Connexion Google",
  ...
  id: {
    ...
    workspaceCtaFootnote: "Akun gratis · Masuk dengan Google",
  ...
  zh: {
    ...
    workspaceCtaFootnote: "免费账号 · 使用 Google 登录",
    roundTitle: "练习回合",
    returnMenu: "返回主菜单",

const PACKS = {
  en: {
    ...
    learners: "Learners",
    learnersCopy: "Create a profile to follow one learner across assignments.",
    learnerUsage: "{used} of {limit} learner profiles",
    learnerName: "Learner nickname or number",
    learnerNamePlaceholder: "Learner 01",
    addLearner: "Add learner",
    viewLearner: "View progress",
    rename: "Rename",
    learnerNamePrompt: "Edit the learner nickname or number",
    ...
    learnerNotFound: "This learner profile could not be found.",
    learnerExists:
      "A learner profile with that nickname or number already exists.",
    learnerLimit:
      "You’ve reached the Free plan limit of 3 learner profiles. Upgrade to Pro for up to 150 learners.",
    smartReviewRequired: "Smart review is available on Pro.",
    proActive:
      "Pro is active. You now have higher limits and longer mastery history.",
  ...
  es: {
    ...
    proActive:
      "Pro está activo. Ya tienes límites más altos y un historial de dominio más largo.",
    rateLimited:
  ...
  "pt-BR": {
    ...
    learners: "Aprendizes",
    learnersCopy:
      "Crie um perfil para acompanhar uma pessoa em várias tarefas.",
    learnerUsage: "{used} de {limit} perfis de aprendiz",
    learnerName: "Apelido ou número do aprendiz",
    learnerNamePlaceholder: "Aprendiz 01",
    addLearner: "Adicionar aprendiz",
    viewLearner: "Ver progresso",
    rename: "Renomear",
    learnerNamePrompt: "Edite o apelido ou número do aprendiz",
    ...
    learnerLimit:
      "Você atingiu o limite de 3 perfis do plano Grátis. Passe para o Pro para acompanhar até 150 aprendizes.",
    smartReviewRequired: "A revisão inteligente está disponível no Pro.",
    proActive:
      "O Pro está ativo. Agora você tem limites maiores e um histórico de domínio mais longo.",
  ...
  fr: {
    ...
    learners: "Apprenants",
    learnersCopy:
      "Créez un profil pour suivre une personne d’un devoir à l’autre.",
    learnerUsage: "{used} profils sur {limit}",
    learnerName: "Pseudo ou numéro de l’apprenant",
    learnerNamePlaceholder: "Apprenant 01",
    addLearner: "Ajouter un apprenant",
    viewLearner: "Voir la progression",
    rename: "Renommer",
    learnerNamePrompt: "Modifiez le pseudo ou le numéro de l’apprenant",
    ...
    learnerLimit:
      "Vous avez atteint la limite gratuite de 3 profils. Passez à Pro pour suivre jusqu’à 150 apprenants.",
    smartReviewRequired: "La révision intelligente est disponible avec Pro.",
    proActive:
      "Pro est actif. Vous bénéficiez maintenant de limites plus élevées et d’un historique plus long.",
  ...
  id: {
    ...
    learners: "Pelajar",
    learnersCopy:
      "Buat profil untuk mengikuti perkembangan satu pelajar di berbagai tugas.",
    learnerUsage: "{used} dari {limit} profil pelajar",
    learnerName: "Nama panggilan atau nomor pelajar",
    learnerNamePlaceholder: "Pelajar 01",
    addLearner: "Tambah pelajar",
    viewLearner: "Lihat perkembangan",
    rename: "Ubah nama",
    learnerNamePrompt: "Edit nama panggilan atau nomor pelajar",
    ...
    learnerNotFound: "Profil pelajar ini tidak ditemukan.",
    learnerExists:
      "Profil dengan nama panggilan atau nomor tersebut sudah ada.",
    learnerLimit:
      "Anda telah mencapai batas 3 profil pada paket Gratis. Pilih Pro untuk menyimpan hingga 150 profil pelajar.",
    smartReviewRequired: "Ulasan pintar tersedia pada paket Pro.",
    proActive:
      "Pro sudah aktif. Kini Anda memiliki batas lebih tinggi dan riwayat penguasaan lebih panjang.",
  ...
  zh: {
    ...
    wordCount: "{count} 个单词",
    learners: "学习者",
    learnersCopy: "创建学习者档案，跨作业查看同一人的学习进度。",
    learnerUsage: "已创建 {used}/{limit} 个学习者档案",
    learnerName: "学习者昵称或编号",
    learnerNamePlaceholder: "学习者 01",
    addLearner: "添加学习者",
    viewLearner: "查看进度",
    rename: "改名",
    learnerNamePrompt: "编辑学习者昵称或编号",
    archiveLearner: "归档",
    restoreLearner: "恢复",
    archived: "已归档",
    ...
    learnerNotFound: "找不到这个学习者档案。",
    learnerExists: "相同昵称或编号的学习者档案已存在。",
    learnerLimit:
      "你已达到免费版 3 个学习者档案的上限。升级 Pro 最多可管理 150 位学习者。",
    smartReviewRequired: "智能错词复习仅 Pro 可用。",
    proActive: "Pro 已激活。你现在拥有更高额度和更长的掌握度历史。",

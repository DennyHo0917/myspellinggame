const PACKS = {
  en: {
    ...
    noAssignments: "No assignments yet. Create one to share with learners.",
    ...
    studentLink: "Learner assignment link",
    copyLink: "Copy learner link",
    close: "Close assignment",
    reopen: "Publish assignment",
    deleteAssignment: "Delete assignment",
    deleteConfirm:
      "Delete this assignment and every learner result? This cannot be undone.",
    exportCsv: "Export CSV",
    statusPublished: "Published",
    statusClosed: "Closed",
    summaryStudents: "Learners",
    summaryAverage: "Average accuracy",
    summarySubmissions: "Submissions",
    results: "Learner results",
    noResults: "No learner has completed this assignment yet.",
    nickname: "Nickname",
    attempt: "Attempt",
    score: "Score",
    accuracy: "Accuracy",
  ...
  es: {
    ...
    noAssignments:
      "Todavía no hay tareas. Crea una para compartirla con aprendices.",
    attempts: "{count} entregas",
    students: "{count} aprendices",
    ...
    studentLink: "Enlace de la tarea para aprendices",
    copyLink: "Copiar enlace para aprendices",
    close: "Cerrar tarea",
    ...
    summaryStudents: "Aprendices",
    summaryAverage: "Precisión media",
    summarySubmissions: "Entregas",
    results: "Resultados de aprendices",
    noResults: "Ningún aprendiz ha terminado esta tarea todavía.",
    nickname: "Apodo",
    attempt: "Intento",
    score: "Puntuación",
    accuracy: "Precisión",
  ...
  "pt-BR": {
    ...
    noAssignments:
      "Ainda não há tarefas. Crie uma para compartilhar com aprendizes.",
    attempts: "{count} envios",
    students: "{count} aprendizes",
    ...
    studentLink: "Link da tarefa para aprendizes",
    copyLink: "Copiar link para aprendizes",
    close: "Fechar tarefa",
    ...
    summaryStudents: "Aprendizes",
    summaryAverage: "Precisão média",
    summarySubmissions: "Envios",
    results: "Resultados dos aprendizes",
    noResults: "Nenhum aprendiz concluiu esta tarefa ainda.",
    nickname: "Apelido",
    attempt: "Tentativa",
    score: "Pontuação",
    accuracy: "Precisão",
  ...
  fr: {
    ...
    noAssignments:
      "Aucun devoir pour le moment. Créez-en un à partager avec les apprenants.",
    attempts: "{count} remises",
    students: "{count} apprenants",
    ...
    studentLink: "Lien du devoir pour les apprenants",
    copyLink: "Copier le lien pour les apprenants",
    ...
    statusClosed: "Fermé",
    summaryStudents: "Apprenants",
    summaryAverage: "Précision moyenne",
    summarySubmissions: "Remises",
    results: "Résultats des apprenants",
    noResults: "Aucun apprenant n’a encore terminé ce devoir.",
    nickname: "Pseudonyme",
    attempt: "Essai",
    score: "Score",
    accuracy: "Précision",
  ...
  id: {
    ...
    noAssignments:
      "Belum ada tugas. Buat tugas untuk dibagikan kepada pelajar.",
    ...
    studentLink: "Link tugas untuk pelajar",
    copyLink: "Salin link untuk pelajar",
    close: "Tutup tugas",
    reopen: "Terbitkan tugas",
    deleteAssignment: "Hapus tugas",
    deleteConfirm:
      "Hapus tugas ini beserta semua hasil pelajar? Tindakan ini tidak dapat dibatalkan.",
    exportCsv: "Ekspor CSV",
    statusPublished: "Diterbitkan",
    statusClosed: "Ditutup",
    summaryStudents: "Pelajar",
    summaryAverage: "Akurasi rata-rata",
    summarySubmissions: "Kiriman",
    results: "Hasil pelajar",
    noResults: "Belum ada pelajar yang menyelesaikan tugas ini.",
  ...
  zh: {
    ...
    noAssignments: "还没有作业。创建一份后即可分享给学习者。",
    attempts: "{count} 次提交",
    students: "{count} 名学习者",
    average: "平均 {count}%",
    due: "截止时间：{date}",
    ...
    deleteConfirm: "确定删除这份作业及全部学习者结果吗？此操作无法撤销。",
    exportCsv: "导出 CSV",
    statusPublished: "已发布",
    statusClosed: "已关闭",

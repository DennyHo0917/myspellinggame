const PACKS = {
  en: {
    ...
    footerSecondaryLinks: ["Pricing", "FAQ", "Privacy", "About", "Contact"],
    ...
    authMissing:
      "Google or Microsoft sign-in is not configured in this environment yet.",
    ...
    savedListsCopy:
      "Save your common word lists to create new spelling assignments quickly.",
    ...
    allLearnersHelp: "Assign to every current learner.",
    allChildren: "All children",
    anyoneWithLink: "Anyone with the link",
    allStudents: "All students",
    selectedStudents: "Selected students",
    selectedLearnersHelp: "Choose one or more learners manually.",
    selectedChildren: "Selected children",
    linkOnlyHelp: "Share by link without binding learners.",
    searchLearners: "Search learners...",
    selectedLearnersCount: "{count} learners selected",
    selectedLearnersPlus: "{name} +{count}",
  ...
  es: {
    ...
    signInMicrosoft: "Continuar con Microsoft",
    ...
    authMissing:
      "El acceso con Google o Microsoft aún no está configurado en este entorno.",
    ...
    speechUnsupported:
      "Este navegador no admite la reproducción de voz. Puedes continuar, pero recomendamos otro navegador para dictados.",
    ...
    savedListsCopy:
      "Guarda tus listas habituales para crear nuevas tareas de spelling rápidamente.",
    ...
    allLearnersHelp: "Asigna la tarea a todos los perfiles actuales.",
    ...
    selectedLearnersHelp: "Elige uno o varios perfiles manualmente.",
    selectedChildren: "Hijos seleccionados",
    linkOnlyHelp: "Comparte por enlace sin vincular perfiles.",
    searchLearners: "Buscar perfiles...",
    selectedLearnersCount: "{count} perfiles seleccionados",
    selectedLearnersPlus: "{name} +{count}",
    selectLearners: "Seleccionar perfiles",
    done: "Listo",
  ...
  "pt-BR": {
    ...
    signInMicrosoft: "Continuar com a Microsoft",
    signOut: "Sair",
    ...
    authMissing:
      "O login com Google ou Microsoft ainda não foi configurado neste ambiente.",
    ...
    speechUnsupported:
      "Este navegador não oferece reprodução de voz. Você pode continuar, mas recomendamos outro navegador para ditado.",
    ...
    savedListsCopy:
      "Salve suas listas habituais para criar novas tarefas de spelling rapidamente.",
    ...
    allLearnersHelp: "Atribua a todos os perfis atuais.",
    ...
    selectedLearnersHelp: "Escolha um ou mais perfis manualmente.",
    selectedChildren: "Filhos selecionados",
    linkOnlyHelp: "Compartilhe por link sem vincular perfis.",
    searchLearners: "Buscar perfis...",
    selectedLearnersCount: "{count} perfis selecionados",
    selectedLearnersPlus: "{name} +{count}",
    selectLearners: "Selecionar perfis",
    done: "Concluir",
  ...
  fr: {
    ...
    signInMicrosoft: "Continuer avec Microsoft",
    ...
    authMissing:
      "La connexion Google ou Microsoft n’est pas encore configurée dans cet environnement.",
    ...
    speechUnsupported:
      "La lecture vocale n’est pas prise en charge par ce navigateur. Vous pouvez continuer, mais un autre navigateur est recommandé pour la dictée.",
    ...
    savedListsCopy:
      "Enregistrez vos listes courantes pour créer rapidement de nouveaux devoirs d’orthographe.",
    ...
    allLearnersHelp: "Attribuez l’exercice à tous les profils actuels.",
    ...
    selectedLearnersHelp: "Choisissez manuellement un ou plusieurs profils.",
    selectedChildren: "Enfants sélectionnés",
    linkOnlyHelp: "Partagez par lien sans associer de profil.",
    searchLearners: "Rechercher un profil...",
    selectedLearnersCount: "{count} profils sélectionnés",
    selectedLearnersPlus: "{name} +{count}",
    selectLearners: "Sélectionner des profils",
    done: "Terminer",
  ...
  id: {
    ...
    signInMicrosoft: "Lanjutkan dengan Microsoft",
    signOut: "Keluar",
    ...
    authMissing:
      "Login Google atau Microsoft belum dikonfigurasi di lingkungan ini.",
    ...
    resumeSubscription: "Lanjutkan langganan",
    ...
    listen: "Putar kata",
    speechUnsupported:
      "Pemutaran suara tidak didukung di browser ini. Anda tetap dapat melanjutkan, tetapi sebaiknya gunakan browser lain untuk dikte.",
    ...
    savedListsCopy:
      "Simpan daftar kata yang sering digunakan untuk membuat tugas mengeja baru dengan cepat.",
    ...
    allLearnersHelp: "Tugaskan kepada semua pelajar saat ini.",
    ...
    selectedLearnersHelp: "Pilih satu atau beberapa pelajar secara manual.",
    selectedChildren: "Anak terpilih",
    linkOnlyHelp: "Bagikan melalui tautan tanpa mengikat pelajar.",
    searchLearners: "Cari pelajar...",
    selectedLearnersCount: "{count} pelajar dipilih",
    selectedLearnersPlus: "{name} +{count}",
    selectLearners: "Pilih pelajar",
    done: "Selesai",
  ...
  zh: {
    ...
    footerSecondaryLinks: ["价格", "常见问题", "隐私", "关于", "联系"],
    footerRights: "版权所有。",
    language: "语言",
    loading: "正在加载…",
    retry: "重试",
    ...
    signIn: "使用 Google 继续",
    signInMicrosoft: "使用 Microsoft 继续",
    signOut: "退出登录",
    signInTitle: "工作台",
    ...
    authMissing: "当前环境尚未配置 Google 或 Microsoft 登录。",
    dashboardTitle: "工作台",
    greeting: "{name}，你好",
    newAssignment: "创建作业",
    plan: "{plan}",
    ...
    proStatsLocked: "教师方案包含整份作业的错词统计和 CSV 导出。查看方案。",
    missedWordsPreview:
      "这份作业中已有 {count} 个不同单词被拼错。教师方案可查看全班最常拼错的单词。查看方案。",
    copied: "学生链接已复制。",
    learnerHome: "学生主页",
    ...
    listen: "播放单词",
    speechUnsupported:
      "此浏览器不支持语音播放。你仍可继续，但建议使用其他浏览器进行听写。",
    typeShown: "输入下方显示的单词。",
    typeHeard: "输入你听到的单词。",
    ...
    activeLimit:
      "已达到免费版最多 1 个活跃作业的限制。请先关闭一份现有作业，或升级方案以提高活跃作业上限。",
    ...
    assignments: "作业",
    savedLists: "已保存词表",
    savedListsCopy: "保存常用词表，可快速创建新的拼写作业",
    ...
    allLearners: "所有学习者",
    allLearnersHelp: "指派给当前全部学习者。",
    allChildren: "所有孩子",
    anyoneWithLink: "任何拥有链接的人",
    allStudents: "所有学生",
    selectedStudents: "选择学生",
    selectedLearnersHelp: "手动选择一个或多个学习者。",
    selectedChildren: "选择孩子",
    linkOnlyHelp: "不绑定学习者，通过链接访问。",
    searchLearners: "搜索学习者...",
    selectedLearnersCount: "已选择 {count} 名学习者",
    selectedLearnersPlus: "{name} +{count}",
    selectLearners: "选择学习者",
    done: "完成",
    classJoin: "班级加入入口",
    classJoinUrl: "班级链接",
    copyClassUrl: "复制班级链接",
    ...
    masteryHistoryUpgrade:
      "免费方案包含 14 天掌握度历史；家长方案和教师方案包含 365 天。查看方案。",
    smartReview: "智能错词复习",
    smartReviewValue: "一键汇总多次作业中的错词，生成针对性的复习词表。",
    smartReviewUpgrade: "家长方案和教师方案支持创建智能错词复习作业。",
    smartReviewPreview:
      "当前有 {count} 个单词需要复习。家长方案和教师方案可一键生成针对性复习作业。查看方案。",
    createReview: "创建复习作业",
    ...
    smartReviewRequired: "智能错词复习包含在家长方案和教师方案中。",
    proActive: "你的付费方案已激活。已解锁词表保存、长期掌握度和智能错词复习。",
...
const TODAYS_REVIEW_COPY = {
  ...
  zh: {
    ...
    todaysReviewUpgrade: "家长方案和教师方案可创建针对性复习作业。",

const PACKS = {
  en: {
    ...
    workspaceTypeTitle: "How will you use My Spelling Game?",
    family: "Parent / Family",
    teacher: "Teacher",
    changeWorkspaceType: "Change workspace type",
  ...
  es: {
    ...
    workspaceTypeTitle: "¿Cómo usarás My Spelling Game?",
    family: "Familia",
    teacher: "Profesor",
    changeWorkspaceType: "Cambiar tipo de espacio",
  ...
  "pt-BR": {
    ...
    workspaceTypeTitle: "Como você usará o My Spelling Game?",
    family: "Família",
    teacher: "Professor",
    changeWorkspaceType: "Alterar tipo de espaço",
  ...
  fr: {
    ...
    workspaceTypeTitle: "Comment utiliserez-vous My Spelling Game ?",
    family: "Famille",
    teacher: "Enseignant",
    changeWorkspaceType: "Changer le type d’espace",
  ...
  id: {
    ...
    workspaceTypeTitle: "Bagaimana Anda akan menggunakan My Spelling Game?",
    family: "Keluarga",
    teacher: "Guru",
    changeWorkspaceType: "Ubah tipe ruang kerja",
  ...
  zh: {
    ...
    workspaceTypeTitle: "你打算如何使用 My Spelling Game？",
    family: "家庭",
    teacher: "教师",
    changeWorkspaceType: "更改工作区类型",
    classJoin: "班级加入入口",
    classJoinUrl: "班级链接",
    studentPin: "学生 PIN",
    copyPin: "复制 PIN",

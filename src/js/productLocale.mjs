const PACKS = {
  en: {
    ...
    signOut: "Sign out",
    signInTitle: "Teacher assignments",
    signInCopy:
  ...
  es: {
    ...
    signInTitle: "Tareas para docentes",
    signInCopy:
  ...
  "pt-BR": {
    ...
    signOut: "Sair",
    signInTitle: "Tarefas para professores",
    signInCopy:
    ...
    dashboardTitle: "Painel do professor",
    greeting: "Olá, {name}",
  ...
  fr: {
    ...
    signInTitle: "Devoirs pour enseignants",
    signInCopy:
    ...
    dashboardTitle: "Espace enseignant",

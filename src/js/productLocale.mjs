const PACKS = {
  en: {
    ...
    retry: "Try again",
    cancel: "Cancel",
    backToDashboard: "Back to teacher workspace",
  ...
  es: {
    ...
    cancel: "Cancelar",
    backToDashboard: "Volver al espacio docente",
  ...
  "pt-BR": {
    ...
    cancel: "Cancelar",
    backToDashboard: "Voltar ao espaço do professor",
  ...
  fr: {
    ...
    retry: "Réessayer",
    cancel: "Annuler",
    backToDashboard: "Retour à l’espace enseignant",
  ...
  id: {
    ...
    retry: "Coba lagi",
    cancel: "Batal",
    backToDashboard: "Kembali ke ruang kerja guru",
